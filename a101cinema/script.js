...
function preload(){
  loadImage("https://aulerius.github.io/a101cinema/main.gif",loadedImage);
}
...
function draw() {
  ...
  if (x+logo_width>=windowWidth){xspeed=-logo_width*logo_speed}
  else if (x<=0){xspeed=logo_width*logo_speed}

  if (y+logo_height>=windowHeight){yspeed=-logo_width*logo_speed}
  else if (y<=0){yspeed=logo_width*logo_speed}
